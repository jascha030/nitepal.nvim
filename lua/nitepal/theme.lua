local darken = require('nitepal.utils').darken
local lighten = require('nitepal.utils').lighten
...
function M.generate(style)
    ...
    if vim.o.background == 'dark' then
        scheme = {
            ...
            bg_highlight = lighten(colors.bg, 0.1),
            bg_popup = colors.bg,
            bg_search = colors.blue,
            bg_sidebar = darken(colors.bg, 0.05),
        ...
        scheme = {
            ...
            bg_dark = colors.bg,
            bg_float = colors.bg,
            bg_highlight = darken(colors.bg, 0.1),
            bg_popup = '#e9e9ec',
            bg_search = '#7890dd',
            bg_sidebar = darken(colors.bg, 0.01),
            ...
            green = darken(colors.bright_green, 0.3),
            green1 = colors.bright_blue,
            green2 = colors.alt_cyan,
            hint = colors.bright_cyan,
            info = colors.cyan,
            ...
            yellow = darken(colors.bright_red, 0.1),
            none = colors.none,
        }
    end
